  ...
  let resObj = {
    status: successState, message: [{
      ...
      // img: 'http://www.liulongbin.top:3005/images/lunbo1-min.jpg'
		img: 'http://localhost:8082/images/mylunbo1.jpg'
    }, {
		id: 2,
      url: 'http://www.itcast.cn/subject/phoneweb/index.html',
      // img: 'http://www.liulongbin.top:3005/images/lunbo2-min.jpg'
		img: 'http://localhost:8082/images/mylunbo2.jpg'
    }, {
		id: 3,
      url: 'http://www.itcast.cn/subject/phoneweb/index.html',
      // img: 'http://www.liulongbin.top:3005/images/lunbo3-min.jpg'
		img: 'http://localhost:8082/images/mylunbo3.jpg'
    }]
  }
...
exports.getimages = (req, res) => {
  ...
  // let cateid = parseInt(req.params.cateid)  - 0;
  let cateid = parseInt(req.params.cateid) ;
  console.log(cateid);
  // console.log(`req.params.cateid=${req.params.cateid}`)
